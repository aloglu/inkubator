...
function normalizePreferences(value) {
    ...
    return {
        ...
        defaults: {
            ...
            pen_nib: toStringOr(defaultsInput.pen_nib, '').trim(),
            pen_nib_material: toStringOr(defaultsInput.pen_nib_material, '').trim(),
...
function normalizeAppData(value) {
    ...
    const currentlyInked = toArray(input.currently_inked)
        ...
        .filter((entry) => {
            ...
            // Preserve placeholder/legacy blank links; these are sanitized elsewhere.
